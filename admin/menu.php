...
<body>
 <div class="breadLine">            
        ...
        <ul class="navigation">            
            ...
            <li>
                <a href="?menu=laptop&act=view">
                    <span class="isw-list"></span><span class="text">Input Data Laptop</span>
                </a>
            </li> <li>
                <a href="?menu=input">
                    <span class="isw-list"></span><span class="text">Input Nilai Laptop</span>
                </a>
            </li> 
            <li>
                <a href="?menu=gap">
           ...
           <li>
                        <a href="?menu=hasil2">
                            <span class="isw-list"></span><span class="text">Laporan Hasil Pemilihan Laptop  </span>
                        </a>                  
                    </li>    
					<li>
                        <a href="?menu=laporan_laptop&act=view">
                            <span class="isw-list"></span><span class="text">Laporan Data Laptop  </span>
                        </a>                  
                    </li>                        
        </ul>
</body>
