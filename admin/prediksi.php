...
<br />
<p>α-predikat1 = MIN(<?php echo number_format($sedikit,4); echo","; echo number_format($tidak_lengkap,4);echo") = $a1";  ?></p>
<p>z1 = <?php echo"3598618-((3598618-1760145)*$a1) =  $z1"; ?></p>

<p>α-predikat2 = MIN(<?php echo number_format($sedikit,4); echo","; echo number_format($sangat_lengkap,4);echo") = $a2";  ?></p>
<p>z2 = <?php echo"1760145-((3598618-1760145)*$a2) =  $z2"; ?></p>           

<p>α-predikat3 = MIN(<?php echo number_format($banyak,4); echo","; echo number_format($tidak_lengkap,4);echo") = $a3";  ?></p>
<p>z3 = <?php echo"3598618-((3598618-1760145)*$a3) =  $z3"; ?></p>

<p>α-predikat4 = MIN(<?php echo number_format($banyak,4); echo","; echo number_format($sangat_lengkap,4);echo") = $a4";  ?></p>
