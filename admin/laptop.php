<?php
if($_GET['act']=="view"){
echo"<a href='?menu=laptop' class='btn btn-info'>Input Data Laptop</a>";
...
echo"<tr>
	...
	<td>$r[hardisk]</td>
	<td>$r[kebutuhan]</td>
	<td><a class='btn btn-small btn-warning' href='laptop.delete.php?inf=$r[id_laptop]' >Hapus</a></td>
</tr>";
}
echo"</table>";
}else{
?>
	...
	<header>
		<h5 align="center" >Input Data Laptop</h5>
	</header>
		<div class="body">
			<form action="simpan_laptop.php" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-lg-4">Jenis Laptop </label>
							<div class="col-lg-4">
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<select name="ukuran" class="form-control"><option value="">Silahkan Dipilih...</option>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<select name="processor" class="form-control"><option value="">Silahkan Dipilih...</option>
								<option value="Intel Core i7">Intel Core i7</option>
								<option value="Intel Core i5">Intel Core i5</option>
								<option value="Intel Core i3">Intel Core i3</option>
								<option value="Core 2 Duo">Core 2 Duo</option>
								<option value="Pentium">Pentium</option></select>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Kapasitas Memori</label>
							<div class="col-lg-4">
								<select name="kapasitas" class="form-control"><option value="">Silahkan Dipilih...</option>
								<option value="8 GB">8 GB</option>
								<option value="4 GB">4 GB</option>
								<option value="3 GB">3 GB</option>
								<option value="2 GB">2 GB</option>
								<option value="1 GB">1 GB</option></select>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Jenis Memori</label>
							<div class="col-lg-4">
								<select name="memori" class="form-control"><option value="">Silahkan Dipilih...</option>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<select name="hardisk" class="form-control"><option value="">Silahkan Dipilih...</option>
								<option value=">640 GB">>640 GB</option>
								<option value="640 GB">640 GB</option>
								<option value="500 GB">500 GB</option>
								<option value="320 GB">320 GB</option>
								<option value="250 GB">250 GB</option></select>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">Kebutuhan</label>
							<div class="col-lg-4">
								<select name="kebutuhan" class="form-control"><option value="">Silahkan Dipilih...</option>
