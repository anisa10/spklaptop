...
<div class="panel panel-default">
	<div class="panel-heading">
		Data Pemilihan Laptop
	</div>
	
	<div class="panel-body">
		<div class="table-responsive">
		<div>
		<p><b>Tabel GAP & Bobot Penilaian Laptop :</b></p>
			...
			<table class="table table-striped table-bordered table-hover">
									<thead>
                                        <tr>
                                            <th rowspan="2">No</th>
                                            <th rowspan="2">Jenis Laptop</th>
                                            <th colspan="7">Hasil Bobot Nilai Laptop</th>
                                        </tr>
                                        <tr>
...
?>
           ...
           <tr>
           <td><?php echo $no2;  ?></td> 
           <td><?php echo $data2[jenis_laptop];  ?></td>
           <td><?php echo"$kur1"; ?></td>
           <td><?php echo"$kur2"; ?></td>
           <td><?php echo"$kur3"; ?></td>
           <td><?php echo"$kur4"; ?></td>
...
?>
									...
									<thead>
                                        <tr>
                                            <th colspan=9><center>Keterangan Bobot Nilai</center></th>
             						<tbody>
									<?php
