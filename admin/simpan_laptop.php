...
$query = mysql_query("insert into datalaptop values('','$_POST[jenis]','$_POST[harga]','$_POST[ukuran]','$_POST[processor]','$_POST[kapasitas]','$_POST[memori]','$_POST[hardisk]','$_POST[kebutuhan]')");

$query1 = mysql_query("insert into proses_spk values('','$_POST[jenis]','$harga','$ukuran','$processor','$kapasitas','$memori','$hardisk','$kebutuhan')");
  
if ($query) {

echo "Data berhasil disimpan";
echo '<META HTTP-EQUIV="Refresh" CONTENT="1; URL=media.php?menu=laptop&act=view">';
